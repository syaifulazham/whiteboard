  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-yellow-50 to-white px-4">
      <div className="flex flex-col items-center gap-6 max-w-md w-full text-center">
        ...
        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-yellow-100 border border-yellow-200 shadow-sm">
        ...
        <div>
          ...
          <p className="mt-2 text-neutral-500 text-base">
            AI-powered collaborative whiteboard. Write, draw, and think — together.
          </p>
        </div>
